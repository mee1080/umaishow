...
object RelationInfo {
    ...
    val filters = buildList {
        ...
        add(2411 to "2012～2013年世代（ゴルシ除く）")
        ...
        add(2533 to "かしわ記念")
        add(2534 to "全日本2歳優駿（全日本3歳優駿を含む）")
        add(2535 to "香港カップ")
        add(2536 to "香港ヴァーズ")

        add(2538 to "クイーンエリザベスII世C")


        add(2541 to "ドバイシーマクラシック（GII時代を含む）")
        add(2542 to "ドバイターフ")
        add(2543 to "ジャック・ル・マロワ賞")
        add(2544 to "サンクルー大賞")
        add(2545 to "モーリスドゲスト賞")

        add(2547 to "BCフィリー&メアターフ")
        add(2548 to "アメリカンオークス")
        add(2601 to "牡馬")
        add(2602 to "牝馬")
        add(2603 to "不明2603")
        add(2604 to "不明2604")
